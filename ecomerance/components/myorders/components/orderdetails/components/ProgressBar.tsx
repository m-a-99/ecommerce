      ...
      <div className="flex  overflow-x-auto customscrollbar py-5">
        <div className="space-y-4 flex flex-col items-center">
          <div className="flex items-center">
            <div className="w-[60px] h-[4px] invisible bg-pink-500"></div>
            <div className=" flex justify-center text-white items-center w-9 h-9 bg-pink-500 rounded-full">
              <i className="fa-regular fa-check"></i>
            </div>
            <div className="w-[60px] h-[4px]  bg-pink-500"></div>
          </div>
        ...
        <div className="space-y-4 flex flex-col items-center">
          <div className="flex items-center">
            ...
            <div className=" flex justify-center text-pink-500 font-semibold items-center w-9 h-9 border-[1px] border-dashed border-pink-500 rounded-full">
              2
            </div>
            <div className="w-[60px] h-[4px]  bg-gray-200"></div>
          </div>
        ...
        <div className="space-y-4 flex flex-col items-center">
          ...
          <div className="font-semibold text-zinc-700 text-center">
